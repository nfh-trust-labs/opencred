  ...
  return (
    <Card className="space-y-6">
      <div className="space-y-2">
        <h2 className="text-lg font-semibold text-txt-primary">Organization Details</h2>
      ...
      <div className="space-y-4">
        <div>
          <label htmlFor="org-name" className="block text-xs font-medium text-txt-secondary">
            Organization Name
          </label>
          <input
            id="org-name"
        ...
        <div>
          <label htmlFor="domain" className="block text-xs font-medium text-txt-secondary">
            Domain
          </label>
          <input
            id="domain"
          ...
          {domain.length > 0 && !domainValid && (
            <p className="mt-1 text-xs text-state-danger">Enter a valid domain name</p>
          )}
        </div>
      </div>
