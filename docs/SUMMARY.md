...
* [DIDs](concepts/dids.md)
  ...
  * [Key lifecycle (active / rotated / revoked)](concepts/dids.md#key-lifecycle--four-states)
  * [did.json and the two-path model](concepts/dids.md#didjson-and-the-two-path-model)
