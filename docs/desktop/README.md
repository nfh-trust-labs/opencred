...
> **Open source, available for macOS, Windows, and Linux.** OpenCred Desktop is MIT-licensed; source and issues live at [github.com/nfh-trust-labs/opencred](https://github.com/nfh-trust-labs/opencred). On first launch macOS shows a one-time security prompt — [Installation → macOS first launch](installation.md#macos-first-launch) walks through the approval step. **Support:** [open an issue](https://github.com/nfh-trust-labs/opencred/issues).
