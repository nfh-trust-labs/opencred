...
export function createRegistry(): SchemaRegistry {
  ...
  registry.registerSchema("education", educationSchema, "https://opencred.dev/contexts/education/v1");
  registry.registerSchema("employment", employmentSchema, "https://opencred.dev/contexts/employment/v1");
