...
export const credentialsV2: Record<string, unknown> = {
  "@context": {
    "@protected": true,
    id: "@id",
    type: "@type",
...
export const dataIntegrityV1: Record<string, unknown> = {
  "@context": {
    "@version": 1.1,
    "@protected": true,
    id: "@id",
...
export const delegationV1: Record<string, unknown> = {
  "@context": {
    "@version": 1.1,
    ocdeleg: "https://opencred.example/ns/delegation#",
    DelegationCertificate: "ocdeleg:DelegationCertificate",
    delegator: {
      "@id": "ocdeleg:delegator",
      "@type": "@id",
    },
    delegatee: {
      "@id": "ocdeleg:delegatee",
      "@type": "@id",
    },
    scope: {
      "@id": "ocdeleg:scope",
    ...
    authorisationPath: "ocdeleg:authorisationPath",
    credentialTypes: {
      "@id": "ocdeleg:credentialTypes",
      "@container": "@set",
    },
    namespaces: {
      "@id": "ocdeleg:namespaces",
      "@container": "@set",
    },
    maxIssuanceCount: {
      "@id": "ocdeleg:maxIssuanceCount",
      "@type": "http://www.w3.org/2001/XMLSchema#integer",
    },
    businessId: "ocdeleg:businessId",
    delegationCertificate: {
      "@id": "ocdeleg:delegationCertificate",
      "@type": "@id",
    },
    delegationCertificateUrl: {
      "@id": "ocdeleg:delegationCertificateUrl",
      "@type": "@id",
    },
    DeDiDelegationStatus: "ocdeleg:DeDiDelegationStatus",
  },
};

export const traceabilityV1: Record<string, unknown> = {
  "@context": {
    "@version": 1.1,
    ...
    PowerOfAttorneyCredential: {
      "@id":
        "https://spec.edmcouncil.org/fibo/ontology/BE/LegalEntities/LegalPersons/PowerOfAttorney",
      "@context": {},
    },
...
export const businessEntityV1: Record<string, unknown> = {
  "@context": {
    ...
    BusinessEntityCredential:
      "https://raw.githubusercontent.com/nfh-trust-labs/opencred-vc-schemas/main/schemas/business-entity/v1#BusinessEntityCredential",
...
export const employmentOfferLetterV1: Record<string, unknown> = {
  "@context": {
    ...
    "@vocab": "https://schema.org/",
    schema: "https://schema.org/",
    EmploymentOfferLetterCredential:
      "https://raw.githubusercontent.com/nfh-trust-labs/opencred-vc-schemas/main/schemas/employment-offer-letter/v1#EmploymentOfferLetterCredential",
  },
};
...
export const functionalIdentityV1: Record<string, unknown> = {
  "@context": {
    ...
    FunctionalIdentityCredential:
      "https://raw.githubusercontent.com/nfh-trust-labs/opencred-vc-schemas/main/schemas/functional-identity/v1#FunctionalIdentityCredential",
...
export const immunizationV1: Record<string, unknown> = {
  "@context": {
    ...
    ImmunizationCredential:
      "https://raw.githubusercontent.com/nfh-trust-labs/opencred-vc-schemas/main/schemas/immunization/v1#ImmunizationCredential",
...
export const insurancePolicyV1: Record<string, unknown> = {
  "@context": {
    ...
    InsurancePolicyCredential:
      "https://raw.githubusercontent.com/nfh-trust-labs/opencred-vc-schemas/main/schemas/insurance-policy/v1#InsurancePolicyCredential",
  },
};
...
export const prescriptionV1: Record<string, unknown> = {
  "@context": {
    ...
    PrescriptionCredential:
      "https://raw.githubusercontent.com/nfh-trust-labs/opencred-vc-schemas/main/schemas/prescription/v1#PrescriptionCredential",
  },
};
...
export const testResultV1: Record<string, unknown> = {
  "@context": {
    ...
    TestResultCredential:
      "https://raw.githubusercontent.com/nfh-trust-labs/opencred-vc-schemas/main/schemas/test-result/v1#TestResultCredential",
  },
};
